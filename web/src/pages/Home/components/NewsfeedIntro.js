...
const reviewData = [
  ...
  },
  {
    ...
    reviewId: 1,
    bookName: 'Súng, vi trùng và thép',
    reviewContent: 'Thay đổi hoàn toàn nhận thức của ta về thế giới. Sách dựa trên bề dày nghiên cứu gần 30 năm của tác giả nên các thông tin vừa mới lạ, hấp dẫn mà cũng đầy tính thuyết phục. Tác giả không chỉ trả lời được câu hỏi tối hậu: “Vì sao  châu Âu là những người đi chinh phục mà không phải châu” Phi?” hay rộng hơn là: “Vì sao dân tộc này lại giỏi hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?i hơn dân tộc khác?'
  },
  {
    username: 'Minh Huy',
    avatar: require('../../../static/images/avatar-placeholder.png'),
